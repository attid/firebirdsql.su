...
```sql
CONNECT 'd:\Work\work.fdb'
USER 'wizard' PASSWORD 'master';
CREATE SHADOW 1 'd:\Work\work.shd';
```
...
CONNECT 'd:\Work\work.fdb'
USER 'wizard' PASSWORD 'master';
CREATE SHADOW 2 'd:\Work\work.sh1'
LENGTH = 5000 PAGES
FILE 'd:\Work\work.sh2';
```

## См. также
[CREATE DATABASE](/create_database/), [ALTER DATABASE](/alter_database/), [DROP DATABASE](/drop_database/), [DROP SHADOW](/drop_shadow/)
