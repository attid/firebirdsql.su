...
| Возвращает | [DOUBLE PRECISION](/tipy_dannyx/) гиперболический тангенс числа в радианах |

## Описание
Функция TANH возвращает (в радинах) гиперболический тангенс угла, переданного в качестве параметра < аргумент > (в радианах).
...
RETURNS
  DOUBLE PRECISION BY VALUE
ENTRY_POINT "tanh" MODULE_NAME SYSTEM;
```

## Пример
```sql
SELECT TANH(0.4321) FROM RDB$DATABASE
```

## См. также
UDF, [Встроенные функции](/vstroennye_funkcii/), [TAN()](/tan/), [ATAN()](/atan/), [ATAN2()](/atan2/), [SIN()](/sin/), [COS()](/cos/), [ACOS()](/acos/), [ASIN()](/asin/)
