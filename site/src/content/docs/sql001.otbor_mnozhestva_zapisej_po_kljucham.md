---
title: "SQL001. Отбор множества записей по ключам"
old_id: sql001.otbor_mnozhestva_zapisej_po_kljucham
section: sql
type: article
firebird:
  since: 
...
## См. также
[SUBSTRING()](/substring/), [CHAR_LENGTH()](/char_length/), [LEFT()](/left/),  [RIGHT()](/right/),  [OVERLAY()](/overlay/),  [POSITION()](/position/)
...
Форум [SQL.RU](http://www.sql.ru/forum/actualtopics.aspx?bid=2), автор: [WildSery](http://www.sql.ru/forum/memberinfo.aspx?mid=68203)
