...
| Возвращает | [DOUBLE PRECISION](/tipy_dannyx/) косинус числа в радианах |

## Описание
Функция COS возвращает (в радинах) косинус угла, переданного в качестве параметра < аргумент > (в радианах).
...
RETURNS
  DOUBLE PRECISION BY VALUE
ENTRY_POINT "cos" MODULE_NAME SYSTEM;
```

## Пример
```sql
SELECT COS(1.234) FROM RDB$DATABASE
```

## См. также
UDF, [Встроенные функции](/vstroennye_funkcii/), [ACOS()](/acos/), [COSH()](/cosh/)
